## Overview
A personal portfolio and blog built with Node.js, Express, EJS and MongoDB. It provides server-side routes for pages and an admin/API interface to manage posts, and serves static client assets from the `/client` folder.
- Create, read, update, and delete blog posts via the admin interface
- Session-based admin access
- Persistent sessions stored in MongoDB when `MONGODB_URI` is set.

## How to run
`Node.js`, `npm`, and a running MongoDB instance if you want persistent storage.
